...
public Plugin:myinfo = 
{
	...
	version		= "1.0.1",
	url		= "https://forums.alliedmods.net/showthread.php?t=241589"
}
...
public OnPluginStart()
{
	...
	new Handle:convar = CreateConVar(CVAR_FILTERMODE_NAME, CVAR_FILTERMODE_VALUE, CVAR_FILTERMODE_DESC, FCVAR_PLUGIN)
...
static ReadVocalizeFilterFile(const String:filename[])
{
	...
	decl String:buffer[129], char, bufferLen
